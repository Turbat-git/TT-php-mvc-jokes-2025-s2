...
<main class="container w-[96ch] mx-auto bg-zinc-50 py-8 px-4 shadow shadow-black/25 space-y-4">
   ...
   <section class="grid grid-cols-12 gap-2">
       ...
       <p class="min-h-12">Gray</p><p class="bg-gray-50">&nbsp;</p><p class="bg-gray-100">&nbsp;</p><p class="bg-gray-200">&nbsp;</p><p class="bg-gray-300">&nbsp;</p><p class="bg-gray-400">&nbsp;</p><p class="bg-gray-500">&nbsp;</p><p class="bg-gray-600">&nbsp;</p><p class="bg-gray-700">&nbsp;</p><p class="bg-gray-800">&nbsp;</p><p class="bg-gray-900">&nbsp;</p><p class="bg-gray-950">&nbsp;</p>
