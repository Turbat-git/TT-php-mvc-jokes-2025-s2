...
<main class="container w-[96ch] mx-auto bg-zinc-50 py-8 px-4 shadow shadow-black/25 space-y-22">
    ...
    <article class="bg-white container mx-auto border  shadow-md p-4 flex flex-col gap-6">
        <h2 class="text-2xl font-semibold text-zinc-50 bg-zinc-600 p-4 pb-6 -mx-4 -mt-4">
            Privacy Policy
        </h2>
        ...
        <section class="-mb-4 -mx-4 bg-red-500 text-white p-4 text-xl space-y-4">
            ...
            <p>
                ...
                website, application, SaaS system, service, product or similar.
            </p>
        </section>
    </article>
    ...
    <article class="bg-white container mx-auto border shadow-md p-4 flex flex-col gap-6">
        ...
        <p class="-mt-6 -mx-4 bg-zinc-200 p-2">
            Last updated <strong>September 28, 2024</strong>
        </p>
        ...
        <h4 class="text-xl text-black text-zinc-700 border-0 border-b border-zinc-700">
            Interpretation and Definitions
        </h4>

        <h5 class="text-lg text-semibold text-zinc-600 underline underline-offset-4">
            Interpretation
        </h5>
        ...
        <h5 class="text-lg text-semibold text-zinc-600 underline underline-offset-4">Definitions
        </h5>
        ...
        <ul class="list-outside list-disc ml-8 space-y-2">
            ...
            <li>
                <strong>Website</strong> refers to http://xxx-interriot-24s2.test, accessible from
                <a href="http://xxx-interriot-24s2.test">http://xxx-interriot-24s2.test</a>.
            </li>
            <li>
        ...
        <h6 class="text-semibold text-zinc-600">
            Personal Data
        </h6>
        ...
        <h5 class="text-lg text-semibold text-zinc-600">
        ...
        <h5 class="text-lg text-semibold text-zinc-600 underline underline-offset-4">Changes to this Privacy Policy
        </h5>
        ...
        <h5 class="text-lg text-semibold text-zinc-600 underline underline-offset-4">Contact Us
        </h5>
