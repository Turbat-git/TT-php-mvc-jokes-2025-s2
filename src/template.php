...
<header class="bg-gray-950 text-gray-200 p-4 flex-grow-0 flex flex-row align-middle content-center">
    <h1 class="flex-0 w-32 text-xl p-4 ">
        <a href="#"
           class="py-4 px-4 -mx-4 -my-4 font-bold  text-gray-300 hover:text-gray-700 hover:bg-gray-300
...
<main class="container mx-auto bg-gray-50 py-8 px-4 shadow shadow-black/25 ">
    <article>
        ...
        <section class="grid grid-cols-2 my-8 gap-4 ">
            ...
            <section class="w-full min-w-64 bg-white shadow  grid grid-cols-3">
                <header class=" bg-gray-700 text-gray-200 text-lg p-4  col-span-1 ">
        ...
        <section class="flex flex-wrap gap-8 justify-stretch">
            ...
            <article class="max-w-96 min-w-64 bg-white shadow  p-2 flex flex-col">
                <header class="-mx-2 bg-gray-700 text-gray-200 text-lg p-4 -mt-2 mb-4  flex-0">
                    <h4>
                        German Shepherd
                    </h4>
                </header>
                ...
                <footer class="-mx-2 bg-gray-200 text-gray-900 text-sm px-4 py-1 mt-4 -mb-2  flex-0 grid grid-cols-2">
